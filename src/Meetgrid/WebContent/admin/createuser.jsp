...
<title>Meetgrid - Crear usuario</title>
...
<a name="top"></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger sticky-top">
      ...
      <div class="container mb-lg-5">
				...
				<form class= "mt-3 mb-2 rounded border border-dark form-row" action="<%=createURI %>" method="post" id="form">
...
//funciones de verificacion de datos
    ...
    function compruebaTodo(){
        ...
        if (primerError==''){
        	alert("Usuario registrado. Facilite los credenciales introducidos al cliente.");
        }else{
