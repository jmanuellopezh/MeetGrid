...
<!--header y barra de navegacion-->
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="ReadUsersByFilters">Perfiles <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
	...
	<h1>Indique el motivo de su reporte a <%=visit.getName() %>:</h1>
	<form action=<%=reportURI %> method="post">
			<input type="text" name="motive">
			<button type="submit" value="enviar">Reportar</button>
		</form>
